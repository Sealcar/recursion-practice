...
debugger
let ans = advancedExponent(2, 2); // 4
ans = advancedExponent(2, 4); // 16
ans = advancedExponent(2, 6); // 64
ans = advancedExponent(2, 8); // 256
ans = advancedExponent(2, 10); // 1024
ans = advancedExponent(2, 12); // 4096
